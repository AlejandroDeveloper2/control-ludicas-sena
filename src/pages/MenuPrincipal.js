...
import VentanaModal from '../components/ModalVentana';
import CerrarSesion from '../components/cerrarSesion';
import FormPerfil from '../components/Formularios/FormPerfilUsuario';

const PanelAdmin=()=>{
    const[menu, setMenu]=useState({
        izquierda:'translateX(0)'
    });
    ...
    //hook para la ventana modal de advertencia
    const [show, setShow] = useState(false);
    //funciones para cambiar estado del modal
    const handleClose = () => setShow(false);
    const handleShow = () => setShow(true);
    //hook para la ventana modal de perfil de usuario
    const [showFormP, setShowFormP]=useState(false);
    //funciones para cambiar el estado del modal
    const handleCloseP = () => setShowFormP(false);
    const handleShowP = () => setShowFormP(true);
        ...
        <div>
            ...
            <MenuHorizontal>
                <InfoUser>
                    ...
                    <BotonPerfil title="Configurar perfil de usuario" onClick={handleShowP}>                         
                    ...
                    <BotonCerrarSesion title="Cerrar sesión" onClick={handleShow}>
            ...
            <Barra></Barra>
            <VentanaModal show={show} handleClose={handleClose} titulo='Mensaje' >
                <CerrarSesion handleClose={handleClose}/>
            </VentanaModal>
            <VentanaModal show={showFormP} handleClose={handleCloseP} titulo='Mi perfil de usuario' >
                <FormPerfil handleClose={handleCloseP}/>
            </VentanaModal>
        </div>
    );
}
