        ...
        <div>
            <Form onSubmit={onSubmit}>
                ...
                <Fila>
                    ...
                    <Input type="email" name="correo"  value={mensajeUsuario.correo} ref={correo_txt} onBlur={onBlurr} onFocus={onFocuss} placeholder="Digite su correo electronico" autoComplete="off" onChange={getMensajeUsuario} /> 
                </Fila> 
                <Fila> 
                    <Col>
